...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "close":
        ...
        await query.edit_message_media(
            InputMediaPhoto("https://graph.org/file/c7de244b6f8e1c57af554-53bd16f895721ea383.jpg", 
                            ABOUT_TXT.format(
                                botname = client.name,
                                ownername = ownername, 
                            )
